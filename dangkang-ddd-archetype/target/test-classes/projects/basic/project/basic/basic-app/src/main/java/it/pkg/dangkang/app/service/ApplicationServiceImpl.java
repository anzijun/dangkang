package it.pkg.dangkang.app.service;

import it.pkg.baidu.unbiz.fluentvalidator.FluentValidator;
import it.pkg.baidu.unbiz.fluentvalidator.jsr303.HibernateSupportedValidator;
import it.pkg.dangkang.app.transaction.ApplicationServiceTransaction;
...
import it.pkg.dangkang.client.dto.validator.PhoneNumberValidator;
...
import static it.pkg.baidu.unbiz.fluentvalidator.ResultCollectors.toSimple;
...
public class ApplicationServiceImpl implements ApplicationService {
    ...
    private void validateParameter(ApplicationServiceDTO applicationServiceDTO){
        it.pkg.baidu.unbiz.fluentvalidator.Result result = FluentValidator.checkAll().failOver()
