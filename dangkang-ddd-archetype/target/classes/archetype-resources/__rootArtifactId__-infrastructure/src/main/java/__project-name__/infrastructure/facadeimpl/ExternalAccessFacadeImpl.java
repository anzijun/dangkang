...
#set( $symbol_dollar = '$' )
#set( $symbol_escape = '\' )
package ${package}.${project-name}.infrastructure.facadeimpl;
...
import ${package}.${project-name}.infrastructure.config.ExternalConfig;
import ${package}.${project-name}.infrastructure.external.*;
