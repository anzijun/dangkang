...
import ${package}.${project-name}.infrastructure.log.datamasking.strategy.EmailMask;
import ${package}.${project-name}.infrastructure.log.datamasking.strategy.HashMask;
import ${package}.${project-name}.infrastructure.log.datamasking.strategy.NameMask;
import ${package}.${project-name}.infrastructure.log.datamasking.strategy.PartMask;
