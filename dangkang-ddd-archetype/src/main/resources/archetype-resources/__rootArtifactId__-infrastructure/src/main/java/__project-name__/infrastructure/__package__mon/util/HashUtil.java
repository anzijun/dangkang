...
#set( $symbol_dollar = '$' )
#set( $symbol_escape = '\' )
package ${package}.${project-name}.infrastructure.${package}mon.util;

import ${package}.${project-name}.infrastructure.${package}mon.annotation.NotNull;
import ${package}.${project-name}.infrastructure.${package}mon.annotation.Nullable;
import ${package}.google.${package}mon.base.Charsets;
import ${package}.google.${package}mon.hash.Hashing;
import org.apache.${package}mons.lang3.Validate;
...
public class HashUtil {
     ...
     *
     * @see ${symbol_pound}generateSalt(int)
     */
