package com.dangkang.log.logmasking.util;

import com.dangkang.log.logmasking.annotation.NotNull;
import com.dangkang.log.logmasking.annotation.Nullable;
            ...
            protected MessageDigest initialValue() {
                try {
                    ...
                    throw new RuntimeException(
                            "unexpected com.dangkang.exception creating MessageDigest instance for [" + digest + ']', e);
                }
            }
        };
    }
